...
| `tdxtap` | A-share / HK / US | none | local Parquet snapshot exported by the external `tdxtap` CLI to `~/.vibe-trading/data-bridge/tdxtap/` (explicit-only, never in auto fallback) |
