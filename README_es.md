...
| `tdxtap` | A / HK / EE. UU. | ninguna | instantánea Parquet local exportada por la CLI externa `tdxtap` a `~/.vibe-trading/data-bridge/tdxtap/` (solo por selección explícita, nunca en el fallback automático) |
...
│       ├── loaders/                #   28 fuentes: tushare, okx, nobitex, wallex, binance, yfinance, akshare, baostock, tencent, mootdx, ccxt, futu, pykrx, local, eastmoney, sina, stooq, yahoo, finnhub, alphavantage, tiingo, fmp, longbridge, mt5, qveris, india_broker, tickerall, tdxtap
